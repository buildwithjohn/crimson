...
const LINKS = {
  Platform: [
    ...
    { label:"Logistics Model",    href:"/#logistics"  },
  ...
  Partnerships: [
    { label:"Government",         href:"/#partnerships"},
    { label:"Hospitals",          href:"/#partnerships"},
    { label:"Investors",          href:"/#contact"    },
    { label:"NGOs",               href:"/#contact"    },
    { label:"DFIs",               href:"/#contact"    },
          ...
          {Object.entries(LINKS).map(([group, links]) => (
            <div key={group}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                {links.map(l => (
                  <Link key={l.label} href={l.href} style={{ fontSize: 13, color: "rgba(255,255,255,.36)", textDecoration: "none", transition: "color .2s" }}
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,.06)", marginTop: "clamp(40px,5vw,60px)", paddingTop: 24, display: "flex", flexWrap: "wrap", gap: 12, justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", gap: 24 }}>
            {[
              ...
              <Link key={l.label} href={l.href} className="caption" style={{ color: "rgba(255,255,255,.18)", fontSize: 9, textDecoration: "none" }}>{l.label}</Link>
            ))}
          </div>
