...
const STEPS = [
  ...
  { num:"03", icon:FlaskConical, title:"Screening & Processing",         body:"Blood is transported to Ogun State-approved screening centers and CrimsonWings facilities for initial screening and component processing.",                                                                           image:"/phase-02.png",           color:"#CC0000" },
